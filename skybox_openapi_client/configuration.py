...
conf = skybox_openapi_client.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self._base_path = "https://skybox.vividseats.com/services" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("skybox_openapi_client")
    ...
    def auth_settings(self):
        ...
        if 'Authorization_Token' in self.api_key:
        ...
        if 'Application_Token' in self.api_key:
