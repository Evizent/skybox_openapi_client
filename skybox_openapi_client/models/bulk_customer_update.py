...
class BulkCustomerUpdate(BaseModel):
    ...
    BulkCustomerUpdate
    """ # noqa: E501
    customer_ids: List[StrictInt] = Field(description="Customer id's which will be updated.", alias="customerIds")
    payment_method: Optional[StrictStr] = Field(default=None, description="Payment method to update.", alias="paymentMethod")
    customer_type: Optional[StrictStr] = Field(default=None, description="Customer type to update.", alias="customerType")
    __properties: ClassVar[List[str]] = ["customerIds", "paymentMethod", "customerType"]
