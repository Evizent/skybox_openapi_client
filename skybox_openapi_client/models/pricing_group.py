...
class PricingGroup(BaseModel):
    ...
    production_id: StrictInt = Field(alias="productionId")
    pricing_group_id: StrictStr = Field(alias="pricingGroupId")
    pricing_group_name: Optional[StrictStr] = Field(default=None, alias="pricingGroupName")
    active: StrictBool
    inventory: Annotated[List[PricingGroupInventory], Field(min_length=1, max_length=2147483647)]
    updated_by_user: StrictInt = Field(alias="updatedByUser")
    updated_date: datetime = Field(alias="updatedDate")
    __properties: ClassVar[List[str]] = ["accountId", "productionId", "pricingGroupId", "pricingGroupName", "active", "inventory", "updatedByUser", "updatedDate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "productionId": obj.get("productionId"),
            "pricingGroupId": obj.get("pricingGroupId"),
            "pricingGroupName": obj.get("pricingGroupName"),
            "active": obj.get("active"),
            "inventory": [PricingGroupInventory.from_dict(_item) for _item in obj["inventory"]] if obj.get("inventory") is not None else None,
