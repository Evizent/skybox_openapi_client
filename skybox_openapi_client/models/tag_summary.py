...
class TagSummary(BaseModel):
    ...
    inventory_count: Optional[StrictInt] = Field(default=None, alias="inventoryCount")
    invoice_count: Optional[StrictInt] = Field(default=None, alias="invoiceCount")
    po_count: Optional[StrictInt] = Field(default=None, alias="poCount")
    event_count: Optional[StrictInt] = Field(default=None, alias="eventCount")
    customer_count: Optional[StrictInt] = Field(default=None, alias="customerCount")
    vendor_count: Optional[StrictInt] = Field(default=None, alias="vendorCount")
    total_count: Optional[StrictInt] = Field(default=None, alias="totalCount")
    __properties: ClassVar[List[str]] = ["id", "tag", "tagType", "inventoryCount", "invoiceCount", "poCount", "eventCount", "customerCount", "vendorCount", "totalCount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "inventoryCount": obj.get("inventoryCount"),
            "invoiceCount": obj.get("invoiceCount"),
            "poCount": obj.get("poCount"),
            "eventCount": obj.get("eventCount"),
            "customerCount": obj.get("customerCount"),
            "vendorCount": obj.get("vendorCount"),
