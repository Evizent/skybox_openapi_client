...
class BulkSwapEventRequest(BaseModel):
    """
    BulkSwapEventRequest
    """ # noqa: E501
    inventory_ids: Optional[List[StrictInt]] = Field(default=None, description="Inventory ids whose event will be swapped.", alias="inventoryIds")
    event_id: Optional[StrictInt] = Field(default=None, description="The new event id for the inventory items.", alias="eventId")
    __properties: ClassVar[List[str]] = ["inventoryIds", "eventId"]
