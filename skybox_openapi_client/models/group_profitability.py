...
class GroupProfitability(BaseModel):
    """
    GroupProfitability
    """ # noqa: E501
    item: Optional[VividSeatsMapGroups] = None
    profit: Optional[ProfitAndLoss] = None
    __properties: ClassVar[List[str]] = ["item", "profit"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "item": VividSeatsMapGroups.from_dict(obj["item"]) if obj.get("item") is not None else None,
