...
class EventPosition(BaseModel):
    ...
    listing_count: Optional[StrictInt] = Field(default=None, alias="listingCount")
    vivid_seats_event_url: Optional[StrictStr] = Field(default=None, alias="vividSeatsEventUrl")
    __properties: ClassVar[List[str]] = ["id", "name", "date", "venue", "performerId", "performer", "keywords", "chartUrl", "stubhubEventId", "stubhubEventUrl", "tags", "notes", "eiEventId", "optOutReplenishment", "ticketCount", "mySoldTickets", "myCancelledTickets", "disabled", "quantity", "cost", "lastPriceUpdate", "listingCount", "vividSeatsEventUrl"]
