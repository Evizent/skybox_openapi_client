...
class HeatMapSeatMapResponse(BaseModel):
    """
    HeatMapSeatMapResponse
    """ # noqa: E501
    var_global: Optional[VividSeatsListingGlobal] = Field(default=None, alias="global")
    sections: Optional[List[SectionProfitability]] = None
    groups: Optional[List[GroupProfitability]] = None
    sales_in_multiple_events: Optional[StrictBool] = Field(default=None, alias="salesInMultipleEvents")
    __properties: ClassVar[List[str]] = ["global", "sections", "groups", "salesInMultipleEvents"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "global": VividSeatsListingGlobal.from_dict(obj["global"]) if obj.get("global") is not None else None,
            "sections": [SectionProfitability.from_dict(_item) for _item in obj["sections"]] if obj.get("sections") is not None else None,
            "groups": [GroupProfitability.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None,
            "salesInMultipleEvents": obj.get("salesInMultipleEvents")
        })
        return _obj
