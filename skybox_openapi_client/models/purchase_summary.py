...
class PurchaseSummary(BaseModel):
    ...
    vendor_id: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(default=None, alias="vendorId")
    ...
    consignment: Optional[Consignment] = None
    ...
    auto_po: Optional[StrictBool] = Field(default=None, alias="autoPo")
    ...
    last_purchase_payment_note: Optional[StrictStr] = Field(default=None, alias="lastPurchasePaymentNote")
    has_zone_seating_inventory: Optional[StrictBool] = Field(default=None, alias="hasZoneSeatingInventory")
    __properties: ClassVar[List[str]] = ["id", "vendorId", "accountId", "internalId", "lines", "purchaseTerm", "paymentMethod", "paymentRef", "deliveryMethod", "shippingAddressId", "billingAddressId", "taxAmount", "shippingAmount", "otherAmount", "internalNotes", "publicNotes", "createdDate", "lastUpdate", "dueDate", "tags", "createdBy", "lastUpdateBy", "externalRef", "paymentStatus", "creditCardId", "creditCardGroupId", "currencyCode", "payments", "notes", "received", "consignment", "cooperative", "status", "airbill", "outstandingBalance", "autoPo", "displayName", "consignmentStatus", "eventName", "quantity", "section", "row", "lineCount", "lineTotal", "total", "totalPayments", "lastPurchasePaymentNote", "hasZoneSeatingInventory"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.notes:
            ...
            _dict['notes'] = _items
        # override the default output from pydantic by calling `to_dict()` of consignment
        if self.consignment:
            _dict['consignment'] = self.consignment.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "payments": [PurchasePayment.from_dict(_item) for _item in obj["payments"]] if obj.get("payments") is not None else None,
            "notes": [PurchaseNote.from_dict(_item) for _item in obj["notes"]] if obj.get("notes") is not None else None,
            "received": obj.get("received"),
            "consignment": Consignment.from_dict(obj["consignment"]) if obj.get("consignment") is not None else None,
            "cooperative": obj.get("cooperative"),
            "status": obj.get("status"),
            "airbill": obj.get("airbill"),
            "outstandingBalance": obj.get("outstandingBalance"),
            "autoPo": obj.get("autoPo"),
            ...
            "lastPurchasePaymentNote": obj.get("lastPurchasePaymentNote"),
            "hasZoneSeatingInventory": obj.get("hasZoneSeatingInventory")
        })
        return _obj
