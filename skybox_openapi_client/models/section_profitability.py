...
class SectionProfitability(BaseModel):
    """
    SectionProfitability
    """ # noqa: E501
    item: Optional[Ticket] = None
    profit: Optional[ProfitAndLoss] = None
    vivid_seats_section: Optional[VividSeatsSection] = Field(default=None, alias="vividSeatsSection")
    __properties: ClassVar[List[str]] = ["item", "profit", "vividSeatsSection"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of vivid_seats_section
        if self.vivid_seats_section:
            _dict['vividSeatsSection'] = self.vivid_seats_section.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "item": Ticket.from_dict(obj["item"]) if obj.get("item") is not None else None,
            "profit": ProfitAndLoss.from_dict(obj["profit"]) if obj.get("profit") is not None else None,
            "vividSeatsSection": VividSeatsSection.from_dict(obj["vividSeatsSection"]) if obj.get("vividSeatsSection") is not None else None
        })
        return _obj
