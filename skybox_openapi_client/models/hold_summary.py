...
class HoldSummary(BaseModel):
    ...
    inventory_id: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(default=None, alias="inventoryId")
    user: Optional[StrictStr] = None
    user_id: Optional[StrictInt] = Field(default=None, alias="userId")
    removed_by_user_id: Optional[StrictInt] = Field(default=None, alias="removedByUserId")
    ...
    __properties: ClassVar[List[str]] = ["id", "accountId", "inventoryId", "user", "userId", "removedByUserId", "createdDate", "expiryDate", "customerId", "removedDate", "notes", "externalRef", "quantity", "section", "row", "seats", "cost", "listPrice", "eventId", "customer", "inventory", "event"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "removedByUserId": obj.get("removedByUserId"),
