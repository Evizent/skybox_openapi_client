...
class ConsignmentLine(BaseModel):
    """
    ConsignmentLine
    """ # noqa: E501
    ...
    invoice_line_id: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(default=None, alias="invoiceLineId")
    open: Optional[StrictBool] = None
    original_unit_cost: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="originalUnitCost")
    mode: Optional[StrictStr] = None
    consignment_value: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="consignmentValue")
    __properties: ClassVar[List[str]] = ["id", "consignmentId", "accountId", "invoiceLineId", "open", "originalUnitCost", "mode", "consignmentValue"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "open": obj.get("open"),
            "originalUnitCost": obj.get("originalUnitCost"),
            "mode": obj.get("mode"),
            "consignmentValue": obj.get("consignmentValue")
        })
        return _obj
