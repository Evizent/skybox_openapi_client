...
class PurchaseLineReplaceAction(BaseModel):
    """
    PurchaseLineReplaceAction
    """ # noqa: E501
    section: Optional[StrictStr] = None
    row: Optional[StrictStr] = None
    low_seat: Optional[StrictInt] = Field(default=None, alias="lowSeat")
    force: Optional[StrictBool] = None
    seat_type: Optional[StrictStr] = Field(default=None, alias="seatType")
    __properties: ClassVar[List[str]] = ["section", "row", "lowSeat", "force", "seatType"]
