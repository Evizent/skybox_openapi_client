...
class Alert(BaseModel):
    ...
    release_alert_id: Optional[StrictInt] = Field(default=None, alias="releaseAlertId")
    __properties: ClassVar[List[str]] = ["id", "creatorId", "accountId", "subject", "message", "alertType", "createdDate", "lastUpdate", "acknowledged", "senderName", "senderEmail", "releaseAlertId"]

    @field_validator('alert_type')
    def alert_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['MESSAGE', 'RELEASE']):
            raise ValueError("must be one of enum values ('MESSAGE', 'RELEASE')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "releaseAlertId": obj.get("releaseAlertId")
        })
        return _obj
