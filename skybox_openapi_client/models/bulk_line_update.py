...
class BulkLineUpdate(BaseModel):
    ...
    BulkLineUpdate
    """ # noqa: E501
    line_ids: List[StrictInt] = Field(description="Line id's which will be updated.", alias="lineIds")
    line_replace_action: Optional[PurchaseLineReplaceAction] = Field(default=None, alias="lineReplaceAction")
    __properties: ClassVar[List[str]] = ["lineIds", "lineReplaceAction"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of line_replace_action
        if self.line_replace_action:
            _dict['lineReplaceAction'] = self.line_replace_action.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "lineIds": obj.get("lineIds"),
            "lineReplaceAction": PurchaseLineReplaceAction.from_dict(obj["lineReplaceAction"]) if obj.get("lineReplaceAction") is not None else None
        })
        return _obj
