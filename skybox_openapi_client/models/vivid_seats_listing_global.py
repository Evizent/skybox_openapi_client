...
class VividSeatsListingGlobal(BaseModel):
    """
    VividSeatsListingGlobal
    """ # noqa: E501
    city: Optional[StrictStr] = None
    event_date: Optional[datetime] = Field(default=None, alias="eventDate")
    production_name: Optional[StrictStr] = Field(default=None, alias="productionName")
    json_file_name: Optional[StrictStr] = Field(default=None, alias="jsonFileName")
    json_active: Optional[StrictBool] = Field(default=None, alias="jsonActive")
    static_map_url: Optional[StrictStr] = Field(default=None, alias="staticMapUrl")
    map_title: Optional[StrictStr] = Field(default=None, alias="mapTitle")
    state: Optional[StrictStr] = None
    dte: Optional[StrictInt] = None
    days_to_event: Optional[StrictInt] = Field(default=None, alias="daysToEvent")
    __properties: ClassVar[List[str]] = ["city", "eventDate", "productionName", "jsonFileName", "jsonActive", "staticMapUrl", "mapTitle", "state", "dte", "daysToEvent"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "productionName": obj.get("productionName"),
            "jsonFileName": obj.get("jsonFileName"),
            "jsonActive": obj.get("jsonActive"),
            "staticMapUrl": obj.get("staticMapUrl"),
            "mapTitle": obj.get("mapTitle"),
            "state": obj.get("state"),
            "dte": obj.get("dte"),
            "daysToEvent": obj.get("daysToEvent")
        })
        return _obj
