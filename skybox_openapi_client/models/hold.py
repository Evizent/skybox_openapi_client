...
class Hold(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "accountId", "inventoryId", "user", "userId", "removedByUserId", "createdDate", "expiryDate", "customerId", "removedDate", "notes", "externalRef", "quantity", "section", "row", "seats", "cost", "listPrice", "eventId"]
