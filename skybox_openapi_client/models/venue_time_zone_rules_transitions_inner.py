...
class VenueTimeZoneRulesTransitionsInner(BaseModel):
    """
    ...
    duration: Optional[VenueTimeZoneRulesTransitionsInnerDuration] = None
    gap: Optional[StrictBool] = None
    date_time_after: Optional[datetime] = Field(default=None, alias="dateTimeAfter")
    date_time_before: Optional[datetime] = Field(default=None, alias="dateTimeBefore")
    overlap: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["offsetBefore", "offsetAfter", "instant", "duration", "gap", "dateTimeAfter", "dateTimeBefore", "overlap"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "duration": VenueTimeZoneRulesTransitionsInnerDuration.from_dict(obj["duration"]) if obj.get("duration") is not None else None,
            "gap": obj.get("gap"),
            "dateTimeAfter": obj.get("dateTimeAfter"),
            "dateTimeBefore": obj.get("dateTimeBefore"),
