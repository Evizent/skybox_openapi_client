...
class VenueTimeZoneRulesTransitionsInnerDuration(BaseModel):
    """
    ...
    negative: Optional[StrictBool] = None
    units: Optional[List[VenueTimeZoneRulesTransitionsInnerDurationUnitsInner]] = None
    __properties: ClassVar[List[str]] = ["seconds", "zero", "nano", "negative", "units"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "units": [VenueTimeZoneRulesTransitionsInnerDurationUnitsInner.from_dict(_item) for _item in obj["units"]] if obj.get("units") is not None else None
        })
        return _obj
