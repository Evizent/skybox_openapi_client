...
class Account(BaseModel):
    ...
    company: StrictStr = Field(description="the company name")
    email: StrictStr = Field(description="the account contact email address")
    first_name: StrictStr = Field(description="account contact's first name", alias="firstName")
    last_name: StrictStr = Field(description="account contact's last name", alias="lastName")
    phone: StrictStr = Field(description="account contact's phone number")
    ...
    address1: StrictStr = Field(description="the company's 1st address line")
    address2: StrictStr = Field(description="the company's 2nd address line")
    city: StrictStr = Field(description="the company's city")
    state: StrictStr = Field(description="the company's state")
    postal_code: StrictStr = Field(description="the company's postal code", alias="postalCode")
    country: StrictStr = Field(description="the company's country")
    logo: StrictStr = Field(description="the company logo")
