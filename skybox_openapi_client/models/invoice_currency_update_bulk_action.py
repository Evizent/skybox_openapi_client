...
class InvoiceCurrencyUpdateBulkAction(BaseModel):
    """
    InvoiceCurrencyUpdateBulkAction
    """ # noqa: E501
    invoice_ids: List[StrictInt] = Field(description="List or invoice ids.", alias="invoiceIds")
    invoice_line_ids: List[StrictInt] = Field(description="List of invoice line ids.", alias="invoiceLineIds")
    ...
    __properties: ClassVar[List[str]] = ["invoiceIds", "invoiceLineIds", "currencyCode", "exchangeRate", "force"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "invoiceLineIds": obj.get("invoiceLineIds"),
