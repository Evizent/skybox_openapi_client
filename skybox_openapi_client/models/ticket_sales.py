...
class TicketSales(BaseModel):
    ...
    sales: Optional[List[TicketSale]] = None
    __properties: ClassVar[List[str]] = ["event", "sales"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sales": [TicketSale.from_dict(_item) for _item in obj["sales"]] if obj.get("sales") is not None else None
        })
        return _obj
