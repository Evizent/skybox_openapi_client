...
class VenueTimeZoneRulesTransitionsInnerOffsetBefore(BaseModel):
    """
    VenueTimeZoneRulesTransitionsInnerOffsetBefore
    """ # noqa: E501
    total_seconds: Optional[StrictInt] = Field(default=None, alias="totalSeconds")
    id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["totalSeconds", "id"]
