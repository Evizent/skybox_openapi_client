...
class InvoiceDeliveryLink(BaseModel):
    """
    InvoiceDeliveryLink
    """ # noqa: E501
    enabled: Optional[StrictBool] = None
    description: Optional[StrictStr] = None
    all_tickets_with_barcodes: Optional[StrictBool] = Field(default=None, alias="allTicketsWithBarcodes")
    all_tickets_with_pdfs: Optional[StrictBool] = Field(default=None, alias="allTicketsWithPdfs")
    __properties: ClassVar[List[str]] = ["enabled", "description", "allTicketsWithBarcodes", "allTicketsWithPdfs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "allTicketsWithBarcodes": obj.get("allTicketsWithBarcodes"),
            "allTicketsWithPdfs": obj.get("allTicketsWithPdfs")
        })
        return _obj
