...
class CurrencyUpdateBulkAction(BaseModel):
    """
    CurrencyUpdateBulkAction
    """ # noqa: E501
    purchase_ids: List[StrictInt] = Field(description="List or purchase ids.", alias="purchaseIds")
    purchase_line_ids: List[StrictInt] = Field(description="List of purchase line ids.", alias="purchaseLineIds")
    currency_code: StrictStr = Field(description="New currency code.", alias="currencyCode")
    exchange_rate: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Exchange rate (null means ignored)", alias="exchangeRate")
    force: Optional[StrictBool] = None
    purchase_line_id: Optional[List[StrictInt]] = Field(default=None, alias="purchaseLineId")
    __properties: ClassVar[List[str]] = ["purchaseIds", "purchaseLineIds", "currencyCode", "exchangeRate", "force", "purchaseLineId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "purchaseLineIds": obj.get("purchaseLineIds"),
