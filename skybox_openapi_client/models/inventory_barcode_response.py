...
class InventoryBarcodeResponse(BaseModel):
    """
    InventoryBarcodeResponse
    """ # noqa: E501
    exchange_pos_id: Optional[StrictInt] = Field(default=None, alias="exchangePosId")
    ...
    seat_number: Optional[StrictInt] = Field(default=None, alias="seatNumber")
    bar_code: Optional[StrictStr] = Field(default=None, alias="barCode")
    external_ticket_id: Optional[StrictStr] = Field(default=None, alias="externalTicketId")
    __properties: ClassVar[List[str]] = ["exchangePosId", "inventoryId", "id", "section", "row", "seatNumber", "barCode", "externalTicketId"]
