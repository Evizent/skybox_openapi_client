...
class CreditCard(BaseModel):
    ...
    billing_address: Optional[BillingAddress] = Field(default=None, alias="billingAddress")
    ...
    __properties: ClassVar[List[str]] = ["token", "billingAddress", "cardholderName", "defaultCard"]
