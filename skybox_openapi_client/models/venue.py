...
class Venue(BaseModel):
    ...
    time_zone: Optional[VenueTimeZone] = Field(default=None, alias="timeZone")
    __properties: ClassVar[List[str]] = ["id", "name", "address", "city", "state", "country", "postalCode", "phone", "timeZone"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "phone": obj.get("phone"),
            "timeZone": VenueTimeZone.from_dict(obj["timeZone"]) if obj.get("timeZone") is not None else None
        })
        return _obj
