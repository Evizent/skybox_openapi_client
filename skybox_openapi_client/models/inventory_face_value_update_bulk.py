...
class InventoryFaceValueUpdateBulk(BaseModel):
    """
    InventoryFaceValueUpdateBulk
    """ # noqa: E501
    new_face_value: Union[Annotated[float, Field(strict=True, ge=0.0)], Annotated[int, Field(strict=True, ge=0)]] = Field(description="Amount to increase or decrease each face value ticket by", alias="newFaceValue")
    id: Annotated[int, Field(strict=True, ge=1)] = Field(description="ID of inventory to update")
    __properties: ClassVar[List[str]] = ["newFaceValue", "id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "newFaceValue": obj.get("newFaceValue"),
            "id": obj.get("id")
        })
        return _obj
