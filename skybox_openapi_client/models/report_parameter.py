...
class ReportParameter(BaseModel):
    ...
    gmt: Optional[StrictBool] = None
    required: Optional[StrictBool] = None
    is_illegal_filter: Optional[StrictBool] = Field(default=None, alias="isIllegalFilter")
    default_hidden: Optional[StrictBool] = Field(default=None, alias="defaultHidden")
    disable_all_any_selector: Optional[StrictBool] = Field(default=None, alias="disableAllAnySelector")
    ...
    illegal_filter: Optional[StrictBool] = Field(default=None, alias="illegalFilter")
    __properties: ClassVar[List[str]] = ["name", "label", "type", "value", "defaultValue", "options", "gmt", "required", "isIllegalFilter", "defaultHidden", "disableAllAnySelector", "table", "column", "pattern", "mode", "isMulti", "illegalFilter"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['DATE', 'DATERANGE', 'EMAIL', 'NUMBER', 'TEXT', 'CUSTOMER', 'VENDOR', 'PERFORMER', 'EVENT_TYPE', 'CATEGORY', 'EXCLUDE_CATEGORY', 'ENUM', 'CHECKBOX', 'BOOLEAN', 'DAYOFWEEK', 'TAGS', 'CREDITCARDGROUP', 'USER', 'MULTIPLE_ENTITY']):
            raise ValueError("must be one of enum values ('DATE', 'DATERANGE', 'EMAIL', 'NUMBER', 'TEXT', 'CUSTOMER', 'VENDOR', 'PERFORMER', 'EVENT_TYPE', 'CATEGORY', 'EXCLUDE_CATEGORY', 'ENUM', 'CHECKBOX', 'BOOLEAN', 'DAYOFWEEK', 'TAGS', 'CREDITCARDGROUP', 'USER', 'MULTIPLE_ENTITY')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isIllegalFilter": obj.get("isIllegalFilter"),
            "defaultHidden": obj.get("defaultHidden"),
            "disableAllAnySelector": obj.get("disableAllAnySelector"),
            "table": obj.get("table"),
            "column": obj.get("column"),
            "pattern": obj.get("pattern"),
            "mode": obj.get("mode"),
            "isMulti": obj.get("isMulti"),
            "illegalFilter": obj.get("illegalFilter")
        })
        return _obj
