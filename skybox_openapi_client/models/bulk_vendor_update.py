...
class BulkVendorUpdate(BaseModel):
    """
    BulkVendorUpdate
    """ # noqa: E501
    vendor_ids: List[StrictInt] = Field(description="Vendor id's which will be updated.", alias="vendorIds")
    payment_method: StrictStr = Field(description="Payment method to update.", alias="paymentMethod")
    __properties: ClassVar[List[str]] = ["vendorIds", "paymentMethod"]
