...
class InventoryPriceUpdateBulk(BaseModel):
    """
    InventoryPriceUpdateBulk
    """ # noqa: E501
    list_price: Union[Annotated[float, Field(strict=True, ge=0.0)], Annotated[int, Field(strict=True, ge=0)]] = Field(description="Amount to increase or decrease each ticket by", alias="listPrice")
    id: Annotated[int, Field(strict=True, ge=1)] = Field(description="ID of inventory to update")
    broadcast: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["listPrice", "id", "broadcast"]
