...
class BulkSoldSwapEventRequest(BaseModel):
    """
    BulkSoldSwapEventRequest
    """ # noqa: E501
    invoice_line_ids: List[StrictInt] = Field(description="Line ids whose event will be swapped.", alias="invoiceLineIds")
    event_id: Optional[StrictInt] = Field(default=None, description="The new event id for the lines items.", alias="eventId")
    __properties: ClassVar[List[str]] = ["invoiceLineIds", "eventId"]
