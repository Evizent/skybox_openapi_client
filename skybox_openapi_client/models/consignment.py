...
class Consignment(BaseModel):
    ...
    purchase_id: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(default=None, alias="purchaseId")
    amount: Union[StrictFloat, StrictInt]
    mode: StrictStr
    completed: Optional[StrictBool] = None
    created: Optional[datetime] = None
    lines: Optional[List[ConsignmentLine]] = None
    __properties: ClassVar[List[str]] = ["id", "accountId", "purchaseId", "amount", "mode", "completed", "created", "lines"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "lines": [ConsignmentLine.from_dict(_item) for _item in obj["lines"]] if obj.get("lines") is not None else None
        })
        return _obj
