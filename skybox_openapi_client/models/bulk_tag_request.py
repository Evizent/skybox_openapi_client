...
class BulkTagRequest(BaseModel):
    ...
    BulkTagRequest
    """ # noqa: E501
    entity_ids: List[StrictInt] = Field(alias="entityIds")
    entity_type: StrictStr = Field(alias="entityType")
    tags_to_add: Optional[List[StrictStr]] = Field(default=None, alias="tagsToAdd")
    tags_to_remove: Optional[List[StrictStr]] = Field(default=None, alias="tagsToRemove")
    clean_old_tags: Optional[StrictBool] = Field(default=None, alias="cleanOldTags")
    __properties: ClassVar[List[str]] = ["entityIds", "entityType", "tagsToAdd", "tagsToRemove", "cleanOldTags"]

    @field_validator('entity_type')
    def entity_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['EVENT', 'CUSTOMER', 'INVENTORY', 'VENDOR', 'PURCHASE', 'INVOICE']):
            raise ValueError("must be one of enum values ('EVENT', 'CUSTOMER', 'INVENTORY', 'VENDOR', 'PURCHASE', 'INVOICE')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cleanOldTags": obj.get("cleanOldTags")
        })
        return _obj
