...
class PerformerPosition(BaseModel):
    """
    PerformerPosition
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "eventType", "category", "quantity", "cost", "listingCount"]
    ...
    def event_type_validate_enum(cls, value):
        ...
        if value not in set(['CONCERT', 'THEATER', 'SPORT', 'OTHER']):
            raise ValueError("must be one of enum values ('CONCERT', 'THEATER', 'SPORT', 'OTHER')")
        return value
