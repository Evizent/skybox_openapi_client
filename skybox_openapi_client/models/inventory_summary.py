...
class InventorySummary(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["inHandDate", "id", "accountId", "eventId", "quantity", "notes", "section", "friendlySection", "row", "friendlyRow", "secondRow", "lowSeat", "highSeat", "cost", "taxedCost", "taxedCostAverage", "faceValue", "tickets", "ticketIds", "stockType", "splitType", "customSplit", "listPrice", "vividRetailPrice", "expectedValue", "publicNotes", "attributes", "status", "inHandDaysBeforeEvent", "lastPriceUpdate", "createdDate", "createdBy", "createdByUserId", "lastUpdate", "lastUpdateBy", "lastDeltaUpdate", "version", "tags", "seatType", "eventMapping", "mappingId", "exchangePosId", "broadcast", "zoneSeating", "electronicTransfer", "optOutAutoPrice", "hideSeatNumbers", "vsrOption", "replenishmentGroupId", "replenishmentGroup", "shownQuantity", "integratedListing", "ticketsMerged", "ticketsSplit", "auditNote", "filesUploaded", "barCodesEntered", "externalTicketIdEntered", "instantTransfer", "seatNumbers", "listed", "consignmentStatus", "cooperative", "holdId", "hold", "unitCostAverage", "faceValueAverage", "currencies", "received", "vendorId", "inHand", "hasTaxedCost", "daysOld", "taxTags", "ticketIdString", "event"]
