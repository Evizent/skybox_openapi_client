...
class ExpectedValueUpdateBulk(BaseModel):
    """
    ExpectedValueUpdateBulk
    """ # noqa: E501
    expected_value: Union[Annotated[float, Field(strict=True, ge=0.0)], Annotated[int, Field(strict=True, ge=0)]] = Field(description="Amount to increase or decrease each ticket by", alias="expectedValue")
    id: Annotated[int, Field(strict=True, ge=1)] = Field(description="ID of inventory to update")
    __properties: ClassVar[List[str]] = ["expectedValue", "id"]
