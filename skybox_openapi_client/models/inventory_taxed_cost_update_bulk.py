...
class InventoryTaxedCostUpdateBulk(BaseModel):
    """
    InventoryTaxedCostUpdateBulk
    """ # noqa: E501
    new_taxed_cost: Union[Annotated[float, Field(strict=True, ge=0.0)], Annotated[int, Field(strict=True, ge=0)]] = Field(description="Amount to increase or decrease each taxed cost ticket by", alias="newTaxedCost")
    id: Annotated[int, Field(strict=True, ge=1)] = Field(description="ID of inventory to update")
    __properties: ClassVar[List[str]] = ["newTaxedCost", "id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "newTaxedCost": obj.get("newTaxedCost"),
            "id": obj.get("id")
        })
        return _obj
