...
class PdfDetails(BaseModel):
    ...
    PdfDetails
    """ # noqa: E501
    page_number: Optional[StrictInt] = Field(default=None, description="the page number within the original PDF", alias="pageNumber")
    pdf_url: Optional[StrictStr] = Field(default=None, description="the url for the individual pdf page", alias="pdfUrl")
    __properties: ClassVar[List[str]] = ["pageNumber", "pdfUrl"]
