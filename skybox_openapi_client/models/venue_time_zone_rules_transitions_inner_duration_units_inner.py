...
class VenueTimeZoneRulesTransitionsInnerDurationUnitsInner(BaseModel):
    """
    VenueTimeZoneRulesTransitionsInnerDurationUnitsInner
    """ # noqa: E501
    duration_estimated: Optional[StrictBool] = Field(default=None, alias="durationEstimated")
    time_based: Optional[StrictBool] = Field(default=None, alias="timeBased")
    date_based: Optional[StrictBool] = Field(default=None, alias="dateBased")
    __properties: ClassVar[List[str]] = ["durationEstimated", "timeBased", "dateBased"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "durationEstimated": obj.get("durationEstimated"),
            "timeBased": obj.get("timeBased"),
            "dateBased": obj.get("dateBased")
        })
        return _obj
