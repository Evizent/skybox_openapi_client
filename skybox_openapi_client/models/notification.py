...
class Notification(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["title", "message", "extra", "type", "alertId"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['MESSAGE', 'RELEASE', 'MAPPING_QUEUE', 'UPCOMING_OPEN_ORDERS', 'EVENT_DELTA']):
            raise ValueError("must be one of enum values ('MESSAGE', 'RELEASE', 'MAPPING_QUEUE', 'UPCOMING_OPEN_ORDERS', 'EVENT_DELTA')")
        return value
