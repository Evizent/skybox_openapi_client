...
class CreditCardGroup(BaseModel):
    """
    CreditCardGroup
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Required for updates, ignored on inserts.")
    account_id: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(default=None, alias="accountId")
    label: Optional[StrictStr] = Field(default=None, description="The label of the credit card group.")
    description: Optional[StrictStr] = Field(default=None, description="The description of the credit card group.")
    credit_cards: Optional[List[CreditCard]] = Field(default=None, alias="creditCards")
    __properties: ClassVar[List[str]] = ["id", "accountId", "label", "description", "creditCards"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "creditCards": [CreditCard.from_dict(_item) for _item in obj["creditCards"]] if obj.get("creditCards") is not None else None
        })
        return _obj
