...
class ReportColumn(BaseModel):
    ...
    data_expression: Optional[StrictStr] = Field(default=None, alias="dataExpression")
    total: Optional[StrictBool] = None
    total_expression: Optional[StrictStr] = Field(default=None, alias="totalExpression")
    ...
    enum_name: Optional[StrictStr] = Field(default=None, alias="enumName")
    link_expression: Optional[StrictStr] = Field(default=None, alias="linkExpression")
    size: Optional[StrictStr] = None
    align: Optional[StrictStr] = None
    copy_to_clipboard: Optional[StrictBool] = Field(default=None, alias="copyToClipboard")
    click_expression: Optional[StrictStr] = Field(default=None, alias="clickExpression")
    minimum: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["name", "label", "value", "dataType", "dataExpression", "total", "totalExpression", "defaultHidden", "maxLength", "enumName", "linkExpression", "size", "align", "copyToClipboard", "clickExpression", "minimum"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dataExpression": obj.get("dataExpression"),
            "total": obj.get("total"),
            "totalExpression": obj.get("totalExpression"),
            "defaultHidden": obj.get("defaultHidden"),
            "maxLength": obj.get("maxLength"),
            "enumName": obj.get("enumName"),
            "linkExpression": obj.get("linkExpression"),
            "size": obj.get("size"),
            "align": obj.get("align"),
            "copyToClipboard": obj.get("copyToClipboard"),
            "clickExpression": obj.get("clickExpression"),
