...
class HoldRequest(BaseModel):
    ...
    low_seat: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(default=None, alias="lowSeat")
    __properties: ClassVar[List[str]] = ["customerId", "notes", "expiryDate", "externalRef", "user", "userId", "inventoryId", "exchangePosId", "quantity", "lowSeat"]
