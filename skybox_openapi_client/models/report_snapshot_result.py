...
class ReportSnapshotResult(BaseModel):
    """
    ...
    filters: Optional[List[ReportSnapshotFilter]] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "accountId", "scheduleId", "reportId", "filters", "assetName", "createdDate", "scheduledDate", "number", "notes", "notificationEmails", "report"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "filters": [ReportSnapshotFilter.from_dict(_item) for _item in obj["filters"]] if obj.get("filters") is not None else None,
