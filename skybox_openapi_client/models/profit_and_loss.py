...
class ProfitAndLoss(BaseModel):
    ...
    ProfitAndLoss
    """ # noqa: E501
    sales: Optional[Union[StrictFloat, StrictInt]] = None
    pl_value: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="plValue")
    pl_percentage: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="plPercentage")
    roi: Optional[Union[StrictFloat, StrictInt]] = None
    avg_ticket_sales: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="avgTicketSales")
    tickets_profitability: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="ticketsProfitability")
    num_tickets: Optional[StrictInt] = Field(default=None, alias="numTickets")
    profitable_tickets: Optional[StrictInt] = Field(default=None, alias="profitableTickets")
    costs: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["sales", "plValue", "plPercentage", "roi", "avgTicketSales", "ticketsProfitability", "numTickets", "profitableTickets", "costs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sales": obj.get("sales"),
            "plValue": obj.get("plValue"),
            "plPercentage": obj.get("plPercentage"),
            "roi": obj.get("roi"),
            "avgTicketSales": obj.get("avgTicketSales"),
            "ticketsProfitability": obj.get("ticketsProfitability"),
            "numTickets": obj.get("numTickets"),
            "profitableTickets": obj.get("profitableTickets"),
            "costs": obj.get("costs")
        })
        return _obj
