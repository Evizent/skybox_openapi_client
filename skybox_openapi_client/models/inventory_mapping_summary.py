...
class InventoryMappingSummary(BaseModel):
    """
    InventoryMappingSummary
    """ # noqa: E501
    event_name: StrictStr = Field(alias="eventName")
    venue_name: StrictStr = Field(alias="venueName")
    ...
    send_count: Optional[StrictInt] = Field(default=None, alias="sendCount")
    mapped_by_user_id: Optional[StrictInt] = Field(default=None, alias="mappedByUserId")
    mapped_date: Optional[datetime] = Field(default=None, alias="mappedDate")
    ...
    __properties: ClassVar[List[str]] = ["eventName", "venueName", "eventDate", "id", "accountId", "purchaseLineId", "createdDate", "responseStatus", "sendCount", "mappedByUserId", "mappedDate", "purchaseId", "quantity", "section", "row", "seats", "cost", "externalRef", "currencyCode", "valid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sendCount": obj.get("sendCount"),
            "mappedByUserId": obj.get("mappedByUserId"),
            "mappedDate": obj.get("mappedDate"),
