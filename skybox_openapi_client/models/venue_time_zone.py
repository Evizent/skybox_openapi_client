...
class VenueTimeZone(BaseModel):
    """
    VenueTimeZone
    """ # noqa: E501
    id: Optional[StrictStr] = None
    rules: Optional[VenueTimeZoneRules] = None
    __properties: ClassVar[List[str]] = ["id", "rules"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "rules": VenueTimeZoneRules.from_dict(obj["rules"]) if obj.get("rules") is not None else None
        })
        return _obj
