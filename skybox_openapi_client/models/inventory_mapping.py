...
class InventoryMapping(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["eventName", "venueName", "eventDate", "id", "accountId", "purchaseLineId", "createdDate", "responseStatus", "sendCount", "mappedByUserId", "mappedDate", "valid"]
