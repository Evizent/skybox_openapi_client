...
class AddressesApi:
    ...
    @validate_call
    def addresses_delete_by_id(
        self,
        address_id: Annotated[StrictInt, Field(description="The address id of the address")],
        ...
        :param address_id: The address id of the address (required)
        :type address_id: int
        ...
        _param = self._addresses_delete_by_id_serialize(
    ...
    @validate_call
    def addresses_delete_by_id_with_http_info(
        self,
        address_id: Annotated[StrictInt, Field(description="The address id of the address")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def addresses_delete_by_id_without_preload_content(
        self,
        address_id: Annotated[StrictInt, Field(description="The address id of the address")],
        _request_timeout: Union[
            None,
    ...
    def _addresses_delete_by_id_serialize(
        self,
        address_id,
        _request_auth,
        _content_type,
        ...
        if address_id is not None:
            _path_params['address-id'] = address_id
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/addresses/{address-id}',
    ...
    def addresses_get_by_id(
        ...
        _param = self._addresses_get_by_id_serialize(
            address_id=address_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def addresses_get_by_id_with_http_info(
        self,
        address_id: Annotated[StrictInt, Field(description="The address id of the address")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def addresses_get_by_id_without_preload_content(
        self,
        address_id: Annotated[StrictInt, Field(description="The address id of the address")],
        _request_timeout: Union[
            None,
    ...
    def _addresses_get_by_id_serialize(
        self,
        address_id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def addresses_insert(
        self,
        address: Annotated[Address, Field(description="An address object to create.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param address: An address object to create. (required)
        ...
        _param = self._addresses_insert_serialize(
            address=address,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def addresses_insert_with_http_info(
        self,
        address: Annotated[Address, Field(description="An address object to create.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def addresses_insert_without_preload_content(
        self,
        address: Annotated[Address, Field(description="An address object to create.")],
        _request_timeout: Union[
            None,
    ...
    def _addresses_insert_serialize(
        self,
        address,
        _request_auth,
        _content_type,
    ...
    def addresses_update(
        self,
        address_id: Annotated[StrictInt, Field(description="The address id of the address")],
        address: Annotated[Address, Field(description="The address object to update.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param address_id: The address id of the address (required)
        :type address_id: int
        :param address: The address object to update. (required)
        :type address: Address
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._addresses_update_serialize(
            address_id=address_id,
            address=address,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def addresses_update_with_http_info(
        self,
        address_id: Annotated[StrictInt, Field(description="The address id of the address")],
        address: Annotated[Address, Field(description="The address object to update.")],
        _request_timeout: Union[
    ...
    @validate_call
    def addresses_update_without_preload_content(
        self,
        address_id: Annotated[StrictInt, Field(description="The address id of the address")],
        address: Annotated[Address, Field(description="The address object to update.")],
        _request_timeout: Union[
    ...
    def _addresses_update_serialize(
        self,
        address_id,
        address,
        _request_auth,
