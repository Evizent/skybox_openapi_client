...
class QuickSearchApi:
    ...
    @validate_call
    def quick_search_search(
        self,
        key: Annotated[StrictStr, Field(description="Key value to search")],
        ...
        :param key: Key value to search (required)
        :type key: str
        ...
        _param = self._quick_search_search_serialize(
            key=key,
    ...
    @validate_call
    def quick_search_search_with_http_info(
        self,
        key: Annotated[StrictStr, Field(description="Key value to search")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def quick_search_search_without_preload_content(
        self,
        key: Annotated[StrictStr, Field(description="Key value to search")],
        _request_timeout: Union[
            None,
    ...
    def _quick_search_search_serialize(
        self,
        key,
        _request_auth,
        _content_type,
