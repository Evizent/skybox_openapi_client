...
class WebhooksApi:
    ...
    def webhooks_create(
        ...
        :param skybox_webhook: (required)
        :type skybox_webhook: SkyboxWebhook
    ...
    def _webhooks_create_serialize(
        ...
        if skybox_webhook is not None:
            _body_params = skybox_webhook
    ...
    def webhooks_find(
        ...
        _param = self._webhooks_find_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def webhooks_find_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def webhooks_find_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def webhooks_query(
        ...
        _param = self._webhooks_query_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def webhooks_query_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[SkyboxWebhook]]:
        """webhooks_query
    ...
    @validate_call
    def webhooks_query_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
