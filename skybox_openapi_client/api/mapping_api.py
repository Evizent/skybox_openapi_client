...
class MappingApi:
    ...
    def mapping_bulk_delete(
        self,
        request_body: Annotated[List[StrictInt], Field(description="The id of the mapping")],
        ...
        :param request_body: The id of the mapping (required)
        ...
        _param = self._mapping_bulk_delete_serialize(
    ...
    @validate_call
    def mapping_bulk_delete_with_http_info(
        self,
        request_body: Annotated[List[StrictInt], Field(description="The id of the mapping")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def mapping_bulk_delete_without_preload_content(
        self,
        request_body: Annotated[List[StrictInt], Field(description="The id of the mapping")],
        _request_timeout: Union[
            None,
    ...
    def _mapping_bulk_delete_serialize(
        self,
        request_body,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/mappings/actions/bulk-cancel',
    ...
    def mapping_delete(
        self,
        mapping_id: Annotated[StrictInt, Field(description="The id of the mapping")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param mapping_id: The id of the mapping (required)
        :type mapping_id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._mapping_delete_serialize(
    ...
    @validate_call
    def mapping_delete_with_http_info(
        self,
        mapping_id: Annotated[StrictInt, Field(description="The id of the mapping")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def mapping_delete_without_preload_content(
        self,
        mapping_id: Annotated[StrictInt, Field(description="The id of the mapping")],
        _request_timeout: Union[
            None,
    ...
    def _mapping_delete_serialize(
        ...
        if mapping_id is not None:
            _path_params['mapping-id'] = mapping_id
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/mappings/{mapping-id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def mapping_find_pending_by_id(
        self,
        mapping_id: Annotated[StrictInt, Field(description="The id of the mapping to retrieve")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param mapping_id: The id of the mapping to retrieve (required)
        :type mapping_id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._mapping_find_pending_by_id_serialize(
            mapping_id=mapping_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def mapping_find_pending_by_id_with_http_info(
        self,
        mapping_id: Annotated[StrictInt, Field(description="The id of the mapping to retrieve")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def mapping_find_pending_by_id_without_preload_content(
        self,
        mapping_id: Annotated[StrictInt, Field(description="The id of the mapping to retrieve")],
        _request_timeout: Union[
            None,
    ...
    def _mapping_find_pending_by_id_serialize(
        self,
        mapping_id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def mapping_get_pending_by_account(
        self,
        ...
        mapping_date_from: Annotated[Optional[datetime], Field(description="Mapping date from range filter")] = None,
        mapping_date_to: Annotated[Optional[datetime], Field(description="Mapping date to range filter")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param mapping_date_from: Mapping date from range filter
        :type mapping_date_from: datetime
        :param mapping_date_to: Mapping date to range filter
        :type mapping_date_to: datetime
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._mapping_get_pending_by_account_serialize(
            ...
            mapping_date_from=mapping_date_from,
            mapping_date_to=mapping_date_to,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[InventoryMappingSummary]",
            '401': None,
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def mapping_get_pending_by_account_with_http_info(
        self,
        purchase_id: Annotated[Optional[List[StrictInt]], Field(description="Purchase Id search filter")] = None,
        external_ref: Annotated[Optional[StrictStr], Field(description="External reference search filter")] = None,
        event: Annotated[Optional[StrictStr], Field(description="Event search filter")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[InventoryMappingSummary]]:
        """mapping_get_pending_by_account
    ...
    @validate_call
    def mapping_get_pending_by_account_without_preload_content(
        self,
        purchase_id: Annotated[Optional[List[StrictInt]], Field(description="Purchase Id search filter")] = None,
        external_ref: Annotated[Optional[StrictStr], Field(description="External reference search filter")] = None,
        event: Annotated[Optional[StrictStr], Field(description="Event search filter")] = None,
    ...
    def _mapping_get_pending_by_account_serialize(
        self,
        purchase_id,
        external_ref,
        event,
        ...
        if mapping_date_from is not None:
            if isinstance(mapping_date_from, datetime):
                _query_params.append(
                    (
                        'mappingDateFrom',
                        mapping_date_from.strftime(
                            self.api_client.configuration.datetime_format
                        )
                    )
                )
            else:
                _query_params.append(('mappingDateFrom', mapping_date_from))
            
        if mapping_date_to is not None:
            if isinstance(mapping_date_to, datetime):
                _query_params.append(
                    (
                        'mappingDateTo',
                        mapping_date_to.strftime(
                            self.api_client.configuration.datetime_format
                        )
                    )
                )
            else:
                _query_params.append(('mappingDateTo', mapping_date_to))
    ...
    @validate_call
    def mapping_resend_mapping_request(
        self,
        mapping_id: Annotated[StrictInt, Field(description="The id of the mapping")],
        _request_timeout: Union[
            None,
        ...
        _param = self._mapping_resend_mapping_request_serialize(
            mapping_id=mapping_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def mapping_resend_mapping_request_with_http_info(
        self,
        mapping_id: Annotated[StrictInt, Field(description="The id of the mapping")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def mapping_resend_mapping_request_without_preload_content(
        self,
        mapping_id: Annotated[StrictInt, Field(description="The id of the mapping")],
        _request_timeout: Union[
            None,
    ...
    def _mapping_resend_mapping_request_serialize(
        self,
        mapping_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/mappings/{mapping-id}/resend',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
