...
class AlertsApi:
    ...
    def alerts_acknowledge(
        self,
        alert_id: Annotated[StrictInt, Field(description="The alert id")],
        ...
        _param = self._alerts_acknowledge_serialize(
            alert_id=alert_id,
    ...
    @validate_call
    def alerts_acknowledge_with_http_info(
        self,
        alert_id: Annotated[StrictInt, Field(description="The alert id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def alerts_acknowledge_without_preload_content(
        self,
        alert_id: Annotated[StrictInt, Field(description="The alert id")],
        _request_timeout: Union[
            None,
    ...
    def _alerts_acknowledge_serialize(
        self,
        alert_id,
        _request_auth,
        _content_type,
        ...
        if alert_id is not None:
            _path_params['alert-id'] = alert_id
