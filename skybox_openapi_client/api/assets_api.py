...
class AssetsApi:
    ...
    def assets_get(
        self,
        filename: Annotated[StrictStr, Field(description="Asset file name")],
        ...
        :param filename: Asset file name (required)
        :type filename: str
    ...
    def assets_upload(
        self,
        pdf_upload: Annotated[PdfUpload, Field(description="The byte array of the PDF")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param pdf_upload: The byte array of the PDF (required)
        :type pdf_upload: PdfUpload
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._assets_upload_serialize(
    ...
    @validate_call
    def assets_upload_with_http_info(
        self,
        pdf_upload: Annotated[PdfUpload, Field(description="The byte array of the PDF")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def assets_upload_without_preload_content(
        self,
        pdf_upload: Annotated[PdfUpload, Field(description="The byte array of the PDF")],
        _request_timeout: Union[
            None,
