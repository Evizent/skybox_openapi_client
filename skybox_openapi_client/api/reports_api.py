...
class ReportsApi:
    ...
    @validate_call
    def reports_get_report_snapshot(
        self,
        id: Annotated[StrictInt, Field(description="The id of the snapshot")],
        ...
        _param = self._reports_get_report_snapshot_serialize(
            id=id,
    ...
    @validate_call
    def reports_get_report_snapshot_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The id of the snapshot")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ReportSnapshotResult]:
        """reports_get_report_snapshot
    ...
    @validate_call
    def reports_get_report_snapshot_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The id of the snapshot")],
        _request_timeout: Union[
            None,
    ...
    def _reports_get_report_snapshot_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/reports/snapshots/{id}',
    ...
    @validate_call
    def reports_query_report_snapshots(
        self,
        report_id: Annotated[Optional[StrictInt], Field(description="Report Id search filter")] = None,
        snapshot_date_from: Annotated[Optional[datetime], Field(description="Snapshot creation date from range filter")] = None,
        snapshot_date_to: Annotated[Optional[datetime], Field(description="Snapshot creation date to range filter")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param report_id: Report Id search filter
        :type report_id: int
        :param snapshot_date_from: Snapshot creation date from range filter
        :type snapshot_date_from: datetime
        :param snapshot_date_to: Snapshot creation date to range filter
        :type snapshot_date_to: datetime
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._reports_query_report_snapshots_serialize(
            report_id=report_id,
    ...
    @validate_call
    def reports_query_report_snapshots_with_http_info(
        self,
        report_id: Annotated[Optional[StrictInt], Field(description="Report Id search filter")] = None,
        snapshot_date_from: Annotated[Optional[datetime], Field(description="Snapshot creation date from range filter")] = None,
        snapshot_date_to: Annotated[Optional[datetime], Field(description="Snapshot creation date to range filter")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ReportSnapshot]]:
        """reports_query_report_snapshots
    ...
    @validate_call
    def reports_query_report_snapshots_without_preload_content(
        self,
        report_id: Annotated[Optional[StrictInt], Field(description="Report Id search filter")] = None,
        snapshot_date_from: Annotated[Optional[datetime], Field(description="Snapshot creation date from range filter")] = None,
        snapshot_date_to: Annotated[Optional[datetime], Field(description="Snapshot creation date to range filter")] = None,
    ...
    def _reports_query_report_snapshots_serialize(
        self,
        report_id,
        snapshot_date_from,
        snapshot_date_to,
        ...
        if snapshot_date_from is not None:
            if isinstance(snapshot_date_from, datetime):
                _query_params.append(
                    (
                        'snapshotDateFrom',
                        snapshot_date_from.strftime(
                            self.api_client.configuration.datetime_format
                        )
                    )
                )
            else:
                _query_params.append(('snapshotDateFrom', snapshot_date_from))
            
        if snapshot_date_to is not None:
            if isinstance(snapshot_date_to, datetime):
                _query_params.append(
                    (
                        'snapshotDateTo',
                        snapshot_date_to.strftime(
                            self.api_client.configuration.datetime_format
                        )
                    )
                )
            else:
                _query_params.append(('snapshotDateTo', snapshot_date_to))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/reports/snapshots',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
