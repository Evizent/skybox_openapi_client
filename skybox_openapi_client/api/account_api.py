...
class AccountApi:
    ...
    def account_get_notifications(
        ...
        _param = self._account_get_notifications_serialize(
    ...
    @validate_call
    def account_get_notifications_with_http_info(
        self,
        client_timezone: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def account_get_notifications_without_preload_content(
        self,
        client_timezone: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
    ...
    def _account_get_notifications_serialize(
        self,
        client_timezone,
        _request_auth,
        _content_type,
        ...
        if client_timezone is not None:
            _header_params['Client-Timezone'] = client_timezone
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/account/notifications',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
