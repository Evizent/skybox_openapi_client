...
from skybox_openapi_client.api_response import ApiResponse, T as ApiResponseT
import skybox_openapi_client.models
from skybox_openapi_client import rest
from skybox_openapi_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(skybox_openapi_client.models, klass)
