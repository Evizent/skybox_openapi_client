...
class TestTagsApi(unittest.TestCase):
    ...
    def test_tags_bulk(self) -> None:
        """Test case for tags_bulk
    ...
    def test_tags_get_filtered_tags(self) -> None:
        """Test case for tags_get_filtered_tags
    ...
    def test_tags_tags_summary(self) -> None:
        """Test case for tags_tags_summary

        """
        pass

    def test_tags_update_color(self) -> None:
        """Test case for tags_update_color
