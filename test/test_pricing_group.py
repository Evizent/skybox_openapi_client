...
class TestPricingGroup(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PricingGroup:
        """Test PricingGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PricingGroup`
        """
        model = PricingGroup()
        if include_optional:
            return PricingGroup(
                ...
                active = True,
                inventory = [
                    skybox_openapi_client.models.pricing_group_inventory.PricingGroupInventory(
                        id = 56, 
                        operation = 56, )
                    ],
                updated_by_user = 56,
