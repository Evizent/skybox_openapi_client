...
class TestConsignment(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Consignment:
        """Test Consignment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Consignment`
        """
        model = Consignment()
        if include_optional:
            return Consignment(
