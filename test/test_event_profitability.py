...
class TestEventProfitability(unittest.TestCase):
    """EventProfitability unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventProfitability:
        """Test EventProfitability
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventProfitability`
        """
        model = EventProfitability()
        if include_optional:
            return EventProfitability(
                item = skybox_openapi_client.models.event.Event(
                    id = 56, 
                    name = '', 
    ...
    def testEventProfitability(self):
        """Test EventProfitability"""
