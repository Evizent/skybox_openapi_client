...
class TestVenueTimeZoneRulesTransitionsInnerDurationUnitsInner(unittest.TestCase):
    """VenueTimeZoneRulesTransitionsInnerDurationUnitsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VenueTimeZoneRulesTransitionsInnerDurationUnitsInner:
        """Test VenueTimeZoneRulesTransitionsInnerDurationUnitsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VenueTimeZoneRulesTransitionsInnerDurationUnitsInner`
        """
        model = VenueTimeZoneRulesTransitionsInnerDurationUnitsInner()
        if include_optional:
            return VenueTimeZoneRulesTransitionsInnerDurationUnitsInner(
    ...
    def testVenueTimeZoneRulesTransitionsInnerDurationUnitsInner(self):
        """Test VenueTimeZoneRulesTransitionsInnerDurationUnitsInner"""
