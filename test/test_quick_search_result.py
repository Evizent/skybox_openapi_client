...
class TestQuickSearchResult(unittest.TestCase):
    """QuickSearchResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QuickSearchResult:
        """Test QuickSearchResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QuickSearchResult`
        """
        model = QuickSearchResult()
        if include_optional:
    ...
    def testQuickSearchResult(self):
        """Test QuickSearchResult"""
