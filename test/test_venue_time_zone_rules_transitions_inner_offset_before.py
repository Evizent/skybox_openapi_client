...
class TestVenueTimeZoneRulesTransitionsInnerOffsetBefore(unittest.TestCase):
    """VenueTimeZoneRulesTransitionsInnerOffsetBefore unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VenueTimeZoneRulesTransitionsInnerOffsetBefore:
        """Test VenueTimeZoneRulesTransitionsInnerOffsetBefore
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VenueTimeZoneRulesTransitionsInnerOffsetBefore`
        """
        model = VenueTimeZoneRulesTransitionsInnerOffsetBefore()
        if include_optional:
            return VenueTimeZoneRulesTransitionsInnerOffsetBefore(
                total_seconds = 56,
                id = ''
            )
        else:
    ...
    def testVenueTimeZoneRulesTransitionsInnerOffsetBefore(self):
        """Test VenueTimeZoneRulesTransitionsInnerOffsetBefore"""
