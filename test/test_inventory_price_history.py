...
class TestInventoryPriceHistory(unittest.TestCase):
    """InventoryPriceHistory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InventoryPriceHistory:
        """Test InventoryPriceHistory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InventoryPriceHistory`
        """
    ...
    def testInventoryPriceHistory(self):
        """Test InventoryPriceHistory"""
