...
class TestVividSeatsSection(unittest.TestCase):
    """VividSeatsSection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VividSeatsSection:
        """Test VividSeatsSection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VividSeatsSection`
        """
        model = VividSeatsSection()
        if include_optional:
            return VividSeatsSection(
                description = '',
                group_id = 56,
                id = 56,
                name = '',
    ...
    def testVividSeatsSection(self):
        """Test VividSeatsSection"""
