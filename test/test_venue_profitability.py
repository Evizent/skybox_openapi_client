...
class TestVenueProfitability(unittest.TestCase):
    """VenueProfitability unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VenueProfitability:
        """Test VenueProfitability
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VenueProfitability`
        """
        model = VenueProfitability()
        if include_optional:
            return VenueProfitability(
                item = skybox_openapi_client.models.venue.Venue(
                    id = 56, 
                    name = '', 
                    address = '', 
                    city = '', 
    ...
    def testVenueProfitability(self):
        """Test VenueProfitability"""
