...
class TestTicketSales(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TicketSales:
        """Test TicketSales
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TicketSales`
        """
        model = TicketSales()
        if include_optional:
            return TicketSales(
                ...
                sales = [
                    skybox_openapi_client.models.ticket_sale.TicketSale(
                        performer = skybox_openapi_client.models.performer.Performer(
                            id = 56, 
                            name = '', 
                            event_type = 'CONCERT', 
