...
class TestSoldInventorySummary(unittest.TestCase):
    """SoldInventorySummary unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SoldInventorySummary:
        """Test SoldInventorySummary
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SoldInventorySummary`
        """
        model = SoldInventorySummary()
        if include_optional:
            return SoldInventorySummary(
                ...
                profit_margin = 1.337,
                roi = 1.337,
                pdfs_or_barcodes_attached = True,
                last_invoice_notes = '',
                last_invoice_notes_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                invoice_airbill = '',
                vendor = '',
                currency_code = 'USD',
                purchase_ids = [
                ...
                unit_ticket_sales = 1.337,
                invoice_created_by = '',
                invoice_tags = '',
                purchase_tags = '',
                outstanding_balance = 1.337,
                event_day_of_week = '',
                invoice_status = 'CONTACT_NEEDED',
                last_invoice_notes_user = '',
                po_created_by = '',
                customer_type = 'MARKETPLACE',
                last_invoice_status_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
    ...
    def testSoldInventorySummary(self):
        """Test SoldInventorySummary"""
