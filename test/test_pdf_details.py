...
class TestPdfDetails(unittest.TestCase):
    """PdfDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PdfDetails:
        """Test PdfDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PdfDetails`
        """
        model = PdfDetails()
        if include_optional:
            return PdfDetails(
