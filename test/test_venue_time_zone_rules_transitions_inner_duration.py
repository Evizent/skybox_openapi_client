...
class TestVenueTimeZoneRulesTransitionsInnerDuration(unittest.TestCase):
    """VenueTimeZoneRulesTransitionsInnerDuration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VenueTimeZoneRulesTransitionsInnerDuration:
        """Test VenueTimeZoneRulesTransitionsInnerDuration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VenueTimeZoneRulesTransitionsInnerDuration`
        """
        model = VenueTimeZoneRulesTransitionsInnerDuration()
        if include_optional:
            return VenueTimeZoneRulesTransitionsInnerDuration(
                seconds = 56,
                zero = True,
                nano = 56,
                negative = True,
    ...
    def testVenueTimeZoneRulesTransitionsInnerDuration(self):
        """Test VenueTimeZoneRulesTransitionsInnerDuration"""
