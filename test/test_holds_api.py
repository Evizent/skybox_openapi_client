...
class TestHoldsApi(unittest.TestCase):
    ...
    def test_holds_delete_by_id(self) -> None:
        """Test case for holds_delete_by_id

        """
        pass

    def test_holds_get_by_id(self) -> None:
        """Test case for holds_get_by_id

        """
        pass

    def test_holds_insert(self) -> None:
        """Test case for holds_insert

        """
        pass

    def test_holds_search(self) -> None:
        """Test case for holds_search

        """
        pass

    def test_holds_update(self) -> None:
        """Test case for holds_update
