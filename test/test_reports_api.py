...
class TestReportsApi(unittest.TestCase):
    ...
    def test_reports_get_report_snapshot(self) -> None:
        """Test case for reports_get_report_snapshot

        """
        pass

    def test_reports_query_report_snapshots(self) -> None:
        """Test case for reports_query_report_snapshots
