...
class TestPurchaseNote(unittest.TestCase):
    """PurchaseNote unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PurchaseNote:
        """Test PurchaseNote
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PurchaseNote`
        """
        model = PurchaseNote()
        if include_optional:
            return PurchaseNote(
