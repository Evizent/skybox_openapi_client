...
class TestQuickReportsApi(unittest.TestCase):
    """QuickReportsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = QuickReportsApi()

    def tearDown(self) -> None:
        pass

    def test_quick_reports_get_purchases(self) -> None:
        """Test case for quick_reports_get_purchases

        """
        pass

    def test_quick_reports_get_sales(self) -> None:
        """Test case for quick_reports_get_sales
