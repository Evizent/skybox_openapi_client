...
class TestExpectedValueUpdateBulk(unittest.TestCase):
    """ExpectedValueUpdateBulk unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExpectedValueUpdateBulk:
        """Test ExpectedValueUpdateBulk
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExpectedValueUpdateBulk`
        """
        model = ExpectedValueUpdateBulk()
        if include_optional:
            return ExpectedValueUpdateBulk(
                expected_value = 0.0,
                id = 1
            )
        else:
    ...
    def testExpectedValueUpdateBulk(self):
        """Test ExpectedValueUpdateBulk"""
