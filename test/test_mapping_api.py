...
class TestMappingApi(unittest.TestCase):
    ...
    def test_mapping_bulk_delete(self) -> None:
        """Test case for mapping_bulk_delete

        """
        pass

    def test_mapping_delete(self) -> None:
        """Test case for mapping_delete

        """
        pass

    def test_mapping_find_pending_by_id(self) -> None:
        """Test case for mapping_find_pending_by_id

        """
        pass

    def test_mapping_get_pending_by_account(self) -> None:
        """Test case for mapping_get_pending_by_account

        """
        pass

    def test_mapping_resend_mapping_request(self) -> None:
        """Test case for mapping_resend_mapping_request
