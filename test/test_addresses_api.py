...
class TestAddressesApi(unittest.TestCase):
    ...
    def test_addresses_delete_by_id(self) -> None:
        """Test case for addresses_delete_by_id

        """
        pass

    def test_addresses_get_by_id(self) -> None:
        """Test case for addresses_get_by_id

        """
        pass

    def test_addresses_insert(self) -> None:
        """Test case for addresses_insert

        """
        pass

    def test_addresses_update(self) -> None:
