...
class TestPurchaseSummary(unittest.TestCase):
    """PurchaseSummary unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PurchaseSummary:
        """Test PurchaseSummary
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PurchaseSummary`
        """
        ...
        if include_optional:
            return PurchaseSummary(
                ...
                consignment = skybox_openapi_client.models.consignment.Consignment(
                    ...
                    lines = [
                        skybox_openapi_client.models.consignment_line.ConsignmentLine(
                            id = 56, 
                            consignment_id = 56, 
                            account_id = 56, 
                            invoice_line_id = 1, 
                            open = True, 
                            original_unit_cost = 1.337, 
                            mode = 'FIXED', 
                            consignment_value = 1.337, )
                        ], ),
                cooperative = True,
                ...
                has_zone_seating_inventory = True
            )
        else:
            return PurchaseSummary(
                lines = [
