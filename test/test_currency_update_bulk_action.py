...
class TestCurrencyUpdateBulkAction(unittest.TestCase):
    """CurrencyUpdateBulkAction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CurrencyUpdateBulkAction:
        """Test CurrencyUpdateBulkAction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CurrencyUpdateBulkAction`
        """
        model = CurrencyUpdateBulkAction()
        if include_optional:
            return CurrencyUpdateBulkAction(
                purchase_ids = [
                    56
                    ],
                purchase_line_ids = [
    ...
    def testCurrencyUpdateBulkAction(self):
        """Test CurrencyUpdateBulkAction"""
