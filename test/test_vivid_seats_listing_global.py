...
class TestVividSeatsListingGlobal(unittest.TestCase):
    """VividSeatsListingGlobal unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VividSeatsListingGlobal:
        """Test VividSeatsListingGlobal
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VividSeatsListingGlobal`
        """
        model = VividSeatsListingGlobal()
        if include_optional:
            return VividSeatsListingGlobal(
                city = '',
    ...
    def testVividSeatsListingGlobal(self):
        """Test VividSeatsListingGlobal"""
