...
class TestInventoryBarcodeResponse(unittest.TestCase):
    """InventoryBarcodeResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InventoryBarcodeResponse:
        """Test InventoryBarcodeResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InventoryBarcodeResponse`
        """
        model = InventoryBarcodeResponse()
        if include_optional:
            return InventoryBarcodeResponse(
                exchange_pos_id = 56,
                inventory_id = 56,
                id = 56,
                section = '',
    ...
    def testInventoryBarcodeResponse(self):
        """Test InventoryBarcodeResponse"""
