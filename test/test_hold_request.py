...
class TestHoldRequest(unittest.TestCase):
    """HoldRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HoldRequest:
        """Test HoldRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HoldRequest`
        """
        model = HoldRequest()
        if include_optional:
            return HoldRequest(
