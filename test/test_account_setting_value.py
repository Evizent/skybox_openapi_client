...
class TestAccountSettingValue(unittest.TestCase):
    """AccountSettingValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccountSettingValue:
        """Test AccountSettingValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccountSettingValue`
        """
        model = AccountSettingValue()
        if include_optional:
            return AccountSettingValue(
            )
        else:
            return AccountSettingValue(
        )
    ...
    def testAccountSettingValue(self):
        """Test AccountSettingValue"""
