...
class TestSyncInventoryRequest(unittest.TestCase):
    """SyncInventoryRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SyncInventoryRequest:
        """Test SyncInventoryRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SyncInventoryRequest`
        """
        model = SyncInventoryRequest()
        if include_optional:
            return SyncInventoryRequest(
                inventory_ids = [
                    56
                    ]
            )
    ...
    def testSyncInventoryRequest(self):
        """Test SyncInventoryRequest"""
