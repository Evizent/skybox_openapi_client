...
class TestVenueTimeZoneRulesTransitionRulesInner(unittest.TestCase):
    """VenueTimeZoneRulesTransitionRulesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VenueTimeZoneRulesTransitionRulesInner:
        """Test VenueTimeZoneRulesTransitionRulesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VenueTimeZoneRulesTransitionRulesInner`
        """
        model = VenueTimeZoneRulesTransitionRulesInner()
        if include_optional:
            return VenueTimeZoneRulesTransitionRulesInner(
                month = 'JANUARY',
                time_definition = 'UTC',
                standard_offset = skybox_openapi_client.models.venue_time_zone_rules_transitions_inner_offset_before.Venue_timeZone_rules_transitions_inner_offsetBefore(
                    total_seconds = 56, 
                    id = '', ),
    ...
    def testVenueTimeZoneRulesTransitionRulesInner(self):
        """Test VenueTimeZoneRulesTransitionRulesInner"""
