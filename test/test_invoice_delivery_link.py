...
class TestInvoiceDeliveryLink(unittest.TestCase):
    """InvoiceDeliveryLink unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InvoiceDeliveryLink:
        """Test InvoiceDeliveryLink
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InvoiceDeliveryLink`
        """
        model = InvoiceDeliveryLink()
        if include_optional:
            return InvoiceDeliveryLink(
                enabled = True,
                description = '',
    ...
    def testInvoiceDeliveryLink(self):
        """Test InvoiceDeliveryLink"""
