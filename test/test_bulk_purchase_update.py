...
class TestBulkPurchaseUpdate(unittest.TestCase):
    """BulkPurchaseUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkPurchaseUpdate:
        """Test BulkPurchaseUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkPurchaseUpdate`
        """
        model = BulkPurchaseUpdate()
        if include_optional:
            return BulkPurchaseUpdate(
                purchase_ids = [
                    56
                    ],
    ...
    def testBulkPurchaseUpdate(self):
        """Test BulkPurchaseUpdate"""
