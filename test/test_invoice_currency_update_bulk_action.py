...
class TestInvoiceCurrencyUpdateBulkAction(unittest.TestCase):
    """InvoiceCurrencyUpdateBulkAction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InvoiceCurrencyUpdateBulkAction:
        """Test InvoiceCurrencyUpdateBulkAction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InvoiceCurrencyUpdateBulkAction`
        """
        model = InvoiceCurrencyUpdateBulkAction()
        if include_optional:
            return InvoiceCurrencyUpdateBulkAction(
                invoice_ids = [
                    56
                    ],
                invoice_line_ids = [
    ...
    def testInvoiceCurrencyUpdateBulkAction(self):
        """Test InvoiceCurrencyUpdateBulkAction"""
