...
class TestInventoryMapping(unittest.TestCase):
    """InventoryMapping unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InventoryMapping:
        """Test InventoryMapping
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InventoryMapping`
        """
