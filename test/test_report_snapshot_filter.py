...
class TestReportSnapshotFilter(unittest.TestCase):
    """ReportSnapshotFilter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportSnapshotFilter:
        """Test ReportSnapshotFilter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportSnapshotFilter`
        """
        model = ReportSnapshotFilter()
        if include_optional:
            return ReportSnapshotFilter(
                name = '',
                label = '',
                label_value = '',
                value = None,
    ...
    def testReportSnapshotFilter(self):
        """Test ReportSnapshotFilter"""
