...
class TestInvoiceNote(unittest.TestCase):
    """InvoiceNote unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InvoiceNote:
        """Test InvoiceNote
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InvoiceNote`
        """
        model = InvoiceNote()
        if include_optional:
            return InvoiceNote(
