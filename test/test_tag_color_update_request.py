...
class TestTagColorUpdateRequest(unittest.TestCase):
    """TagColorUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TagColorUpdateRequest:
        """Test TagColorUpdateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TagColorUpdateRequest`
        """
        model = TagColorUpdateRequest()
        if include_optional:
            return TagColorUpdateRequest(
                tag_name = '',
                color_value = '#gCu'
            )
        else:
    ...
    def testTagColorUpdateRequest(self):
        """Test TagColorUpdateRequest"""
