...
class TestCustomersApi(unittest.TestCase):
    ...
    def test_customers_add_card(self) -> None:
        """Test case for customers_add_card

        """
        pass

    def test_customers_bulk_remove_tags(self) -> None:
        """Test case for customers_bulk_remove_tags

        """
        pass

    def test_customers_bulk_update(self) -> None:
        """Test case for customers_bulk_update
    ...
    def test_customers_get_by_id(self) -> None:
        """Test case for customers_get_by_id

        """
        pass

    def test_customers_get_card(self) -> None:
        """Test case for customers_get_card

        """
        pass

    def test_customers_get_cards(self) -> None:
        """Test case for customers_get_cards

        """
        pass

    def test_customers_get_defaults_by_id(self) -> None:
        """Test case for customers_get_defaults_by_id

        """
        pass

    def test_customers_insert(self) -> None:
        """Test case for customers_insert

        """
        pass

    def test_customers_remove_card(self) -> None:
        """Test case for customers_remove_card

        """
        pass

    def test_customers_search(self) -> None:
        """Test case for customers_search

        """
        pass

    def test_customers_set_default_card(self) -> None:
        """Test case for customers_set_default_card

        """
        pass

    def test_customers_tag(self) -> None:
        """Test case for customers_tag
    ...
    def test_customers_update_default(self) -> None:
        """Test case for customers_update_default
