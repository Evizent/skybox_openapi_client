...
class TestPurchaseLineReplaceAction(unittest.TestCase):
    """PurchaseLineReplaceAction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PurchaseLineReplaceAction:
        """Test PurchaseLineReplaceAction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PurchaseLineReplaceAction`
        """
        model = PurchaseLineReplaceAction()
        if include_optional:
            return PurchaseLineReplaceAction(
                section = '',
                row = '',
                low_seat = 56,
                force = True,
    ...
    def testPurchaseLineReplaceAction(self):
        """Test PurchaseLineReplaceAction"""
