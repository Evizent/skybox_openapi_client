...
class TestInventoryMappingSummary(unittest.TestCase):
    """InventoryMappingSummary unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InventoryMappingSummary:
        """Test InventoryMappingSummary
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InventoryMappingSummary`
        """
        model = InventoryMappingSummary()
        if include_optional:
            return InventoryMappingSummary(
                event_name = '',
                venue_name = '',
                ...
                response_status = 56,
                send_count = 56,
                mapped_by_user_id = 56,
                mapped_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                purchase_id = 56,
                quantity = 56,
                section = '',
                row = '',
    ...
    def testInventoryMappingSummary(self):
        """Test InventoryMappingSummary"""
