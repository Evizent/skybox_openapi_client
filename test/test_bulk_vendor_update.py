...
class TestBulkVendorUpdate(unittest.TestCase):
    """BulkVendorUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkVendorUpdate:
        """Test BulkVendorUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkVendorUpdate`
        """
        model = BulkVendorUpdate()
        if include_optional:
            return BulkVendorUpdate(
                vendor_ids = [
                    56
                    ],
