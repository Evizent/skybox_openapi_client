...
class TestSectionProfitability(unittest.TestCase):
    """SectionProfitability unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SectionProfitability:
        """Test SectionProfitability
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SectionProfitability`
        """
        model = SectionProfitability()
        if include_optional:
            return SectionProfitability(
    ...
    def testSectionProfitability(self):
        """Test SectionProfitability"""
