...
class TestConsignmentLine(unittest.TestCase):
    """ConsignmentLine unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConsignmentLine:
        """Test ConsignmentLine
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConsignmentLine`
        """
        model = ConsignmentLine()
        if include_optional:
            return ConsignmentLine(
                id = 56,
                consignment_id = 56,
                account_id = 56,
                invoice_line_id = 1,
