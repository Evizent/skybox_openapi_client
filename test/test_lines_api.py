...
class TestLinesApi(unittest.TestCase):
    ...
    def test_lines_cancel_invoice_lines(self) -> None:
        """Test case for lines_cancel_invoice_lines

        """
        pass

    def test_lines_delete_invoice_lines(self) -> None:
        """Test case for lines_delete_invoice_lines

        """
        pass

    def test_lines_get_line_by_id(self) -> None:
        """Test case for lines_get_line_by_id
