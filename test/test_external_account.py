    ...
    def make_instance(self, include_optional) -> ExternalAccount:
        ...
        if include_optional:
            return ExternalAccount(
                ...
                last_sweep = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                credit_card_id = 56,
                ...
                markup = 1.337,
                fee = 1.337,
                auto_hide_seat_numbers = True,
                opt_in_stubhub_inhand_date_logic = True,
                opt_in_stub_hub_transfer_details_sweep = True,
                confirm_orders = True
            )
        else:
            return ExternalAccount(
