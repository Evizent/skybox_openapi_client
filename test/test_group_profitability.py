...
class TestGroupProfitability(unittest.TestCase):
    """GroupProfitability unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupProfitability:
        """Test GroupProfitability
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupProfitability`
        """
        model = GroupProfitability()
        if include_optional:
    ...
    def testGroupProfitability(self):
        """Test GroupProfitability"""
