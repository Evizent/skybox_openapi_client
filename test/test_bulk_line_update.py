...
class TestBulkLineUpdate(unittest.TestCase):
    """BulkLineUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkLineUpdate:
        """Test BulkLineUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkLineUpdate`
        """
        model = BulkLineUpdate()
        if include_optional:
            return BulkLineUpdate(
                line_ids = [
                    56
                    ],
                line_replace_action = skybox_openapi_client.models.purchase_line_replace_action.PurchaseLineReplaceAction(
                    section = '', 
                    row = '', 
                    low_seat = 56, 
                    force = True, 
