...
class TestReportColumn(unittest.TestCase):
    """ReportColumn unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportColumn:
        """Test ReportColumn
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportColumn`
        """
        model = ReportColumn()
        if include_optional:
            return ReportColumn(
