...
class TestEventDelta(unittest.TestCase):
    """EventDelta unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventDelta:
        """Test EventDelta
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventDelta`
        """
        model = EventDelta()
        if include_optional:
            return EventDelta(
