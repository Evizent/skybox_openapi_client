...
class TestSkyboxWebhook(unittest.TestCase):
    """SkyboxWebhook unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SkyboxWebhook:
        """Test SkyboxWebhook
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SkyboxWebhook`
        """
        model = SkyboxWebhook()
        if include_optional:
            return SkyboxWebhook(
                id = 56,
                topic = '',
                url = '',
                headers = '',
