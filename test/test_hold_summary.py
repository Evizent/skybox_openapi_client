...
class TestHoldSummary(unittest.TestCase):
    """HoldSummary unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HoldSummary:
        """Test HoldSummary
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HoldSummary`
        """
        model = HoldSummary()
        if include_optional:
            return HoldSummary(
                ...
                list_price = 1.337,
                event_id = 56,
                customer = skybox_openapi_client.models.customer.Customer(
                    id = 56, 
                    account_id = 56, 
                    created_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    ...
                    use_email2 = True, 
                    company = '', 
                    address = skybox_openapi_client.models.address.Address(
                        id = 56, 
                        account_id = 56, 
                        first_name = '', 
                        last_name = '', 
                    ...
                    default_delivery_method = 'COURIER', 
