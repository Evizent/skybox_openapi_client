...
class TestTaxedCostMarketplaceOptIn(unittest.TestCase):
    """TaxedCostMarketplaceOptIn unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaxedCostMarketplaceOptIn:
        """Test TaxedCostMarketplaceOptIn
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaxedCostMarketplaceOptIn`
        """
        model = TaxedCostMarketplaceOptIn()
        if include_optional:
            return TaxedCostMarketplaceOptIn(
    ...
    def testTaxedCostMarketplaceOptIn(self):
        """Test TaxedCostMarketplaceOptIn"""
