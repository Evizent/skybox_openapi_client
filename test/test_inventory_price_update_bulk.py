...
class TestInventoryPriceUpdateBulk(unittest.TestCase):
    """InventoryPriceUpdateBulk unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InventoryPriceUpdateBulk:
        """Test InventoryPriceUpdateBulk
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InventoryPriceUpdateBulk`
        """
        model = InventoryPriceUpdateBulk()
        if include_optional:
            return InventoryPriceUpdateBulk(
                list_price = 0.0,
                id = 1,
                broadcast = True
            )
    ...
    def testInventoryPriceUpdateBulk(self):
        """Test InventoryPriceUpdateBulk"""
