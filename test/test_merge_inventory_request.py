...
class TestMergeInventoryRequest(unittest.TestCase):
    """MergeInventoryRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MergeInventoryRequest:
        """Test MergeInventoryRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MergeInventoryRequest`
        """
        model = MergeInventoryRequest()
        if include_optional:
            return MergeInventoryRequest(
                inventory_ids = [
                    56
                    ],
                public_notes = '',
                merging_type = 'COMBINE'
            )
        else:
            return MergeInventoryRequest(
                inventory_ids = [
    ...
    def testMergeInventoryRequest(self):
        """Test MergeInventoryRequest"""
