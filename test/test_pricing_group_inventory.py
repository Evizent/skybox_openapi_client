...
class TestPricingGroupInventory(unittest.TestCase):
    """PricingGroupInventory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PricingGroupInventory:
        """Test PricingGroupInventory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PricingGroupInventory`
        """
        model = PricingGroupInventory()
        if include_optional:
            return PricingGroupInventory(
                id = 56,
                operation = 56
            )
        else:
    ...
    def testPricingGroupInventory(self):
        """Test PricingGroupInventory"""
