...
class TestBulkCustomerUpdate(unittest.TestCase):
    """BulkCustomerUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkCustomerUpdate:
        """Test BulkCustomerUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkCustomerUpdate`
        """
        model = BulkCustomerUpdate()
        if include_optional:
            return BulkCustomerUpdate(
                customer_ids = [
                    56
                    ],
    ...
    def testBulkCustomerUpdate(self):
        """Test BulkCustomerUpdate"""
