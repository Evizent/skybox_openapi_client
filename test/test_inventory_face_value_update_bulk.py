...
class TestInventoryFaceValueUpdateBulk(unittest.TestCase):
    """InventoryFaceValueUpdateBulk unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InventoryFaceValueUpdateBulk:
        """Test InventoryFaceValueUpdateBulk
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InventoryFaceValueUpdateBulk`
        """
        model = InventoryFaceValueUpdateBulk()
        if include_optional:
            return InventoryFaceValueUpdateBulk(
                new_face_value = 0.0,
                id = 1
            )
        else:
    ...
    def testInventoryFaceValueUpdateBulk(self):
        """Test InventoryFaceValueUpdateBulk"""
