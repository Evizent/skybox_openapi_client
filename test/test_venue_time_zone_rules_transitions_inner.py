...
class TestVenueTimeZoneRulesTransitionsInner(unittest.TestCase):
    """VenueTimeZoneRulesTransitionsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VenueTimeZoneRulesTransitionsInner:
        """Test VenueTimeZoneRulesTransitionsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VenueTimeZoneRulesTransitionsInner`
        """
        model = VenueTimeZoneRulesTransitionsInner()
        if include_optional:
            return VenueTimeZoneRulesTransitionsInner(
    ...
    def testVenueTimeZoneRulesTransitionsInner(self):
        """Test VenueTimeZoneRulesTransitionsInner"""
