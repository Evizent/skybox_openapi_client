...
class TestPerformerPosition(unittest.TestCase):
    """PerformerPosition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PerformerPosition:
        """Test PerformerPosition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PerformerPosition`
        """
        model = PerformerPosition()
        if include_optional:
            return PerformerPosition(
                id = 56,
                name = '',
                event_type = 'CONCERT',
    ...
    def testPerformerPosition(self):
        """Test PerformerPosition"""
