...
class TestBulkSoldSwapEventRequest(unittest.TestCase):
    """BulkSoldSwapEventRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkSoldSwapEventRequest:
        """Test BulkSoldSwapEventRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkSoldSwapEventRequest`
        """
        model = BulkSoldSwapEventRequest()
        if include_optional:
            return BulkSoldSwapEventRequest(
                invoice_line_ids = [
                    56
                    ],
                event_id = 56
    ...
    def testBulkSoldSwapEventRequest(self):
        """Test BulkSoldSwapEventRequest"""
