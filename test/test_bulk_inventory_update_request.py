...
class TestBulkInventoryUpdateRequest(unittest.TestCase):
    """BulkInventoryUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkInventoryUpdateRequest:
        """Test BulkInventoryUpdateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkInventoryUpdateRequest`
        """
        model = BulkInventoryUpdateRequest()
        if include_optional:
            return BulkInventoryUpdateRequest(
                inventory_ids = [
                    56
                    ],
                public_notes_to_replace = '',
                public_notes_to_add = '',
                internal_notes_to_replace = '',
                internal_notes_to_add = '',
                split_type = 'DEFAULT',
                custom_split = '',
                ...
                remove_barcode = True,
                remove_pdf = True,
                remove_external_ticket_id = True,
                ticket_disclosure = '',
                inventory_attribute = '',
                face_value = 0.0,
                ...
                instant_transfer_opted_out = True,
    ...
    def testBulkInventoryUpdateRequest(self):
        """Test BulkInventoryUpdateRequest"""
