...
class TestExchangePosIdHistoryResponse(unittest.TestCase):
    """ExchangePosIdHistoryResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExchangePosIdHistoryResponse:
        """Test ExchangePosIdHistoryResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExchangePosIdHistoryResponse`
        """
        model = ExchangePosIdHistoryResponse()
        if include_optional:
            return ExchangePosIdHistoryResponse(
                exchange_pos_id = 56,
                inventory_id = 56
            )
        else:
    ...
    def testExchangePosIdHistoryResponse(self):
        """Test ExchangePosIdHistoryResponse"""
