...
class TestVividSeatsMapGroups(unittest.TestCase):
    """VividSeatsMapGroups unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VividSeatsMapGroups:
        """Test VividSeatsMapGroups
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VividSeatsMapGroups`
        """
        model = VividSeatsMapGroups()
        if include_optional:
            return VividSeatsMapGroups(
                id = 56,
                name = '',
                color = '',
                map_id = 56
    ...
    def testVividSeatsMapGroups(self):
        """Test VividSeatsMapGroups"""
