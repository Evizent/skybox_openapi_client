...
class TestInvoiceTicket(unittest.TestCase):
    """InvoiceTicket unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InvoiceTicket:
        """Test InvoiceTicket
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InvoiceTicket`
        """
        model = InvoiceTicket()
        if include_optional:
