...
class TestPricingGroupApi(unittest.TestCase):
    """PricingGroupApi unit test stubs"""

    def setUp(self) -> None:
        self.api = PricingGroupApi()

    def tearDown(self) -> None:
        pass

    def test_pricing_group_insert_pricing_group(self) -> None:
        """Test case for pricing_group_insert_pricing_group
