...
class TestPerformerProfitability(unittest.TestCase):
    """PerformerProfitability unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PerformerProfitability:
        """Test PerformerProfitability
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PerformerProfitability`
        """
        model = PerformerProfitability()
        if include_optional:
            return PerformerProfitability(
                item = skybox_openapi_client.models.performer.Performer(
                    id = 56, 
                    name = '', 
                    event_type = 'CONCERT', 
    ...
    def testPerformerProfitability(self):
        """Test PerformerProfitability"""
