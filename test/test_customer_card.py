...
class TestCustomerCard(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CustomerCard:
        """Test CustomerCard
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomerCard`
        """
        model = CustomerCard()
        if include_optional:
            return CustomerCard(
                ...
                customer_id = 56,
                default_card = True,
                last_date_used = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f')
            )
        else:
            return CustomerCard(
                card_type = 'AMEX',
