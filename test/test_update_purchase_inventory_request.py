...
class TestUpdatePurchaseInventoryRequest(unittest.TestCase):
    """UpdatePurchaseInventoryRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdatePurchaseInventoryRequest:
        """Test UpdatePurchaseInventoryRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdatePurchaseInventoryRequest`
        """
        model = UpdatePurchaseInventoryRequest()
        if include_optional:
            return UpdatePurchaseInventoryRequest(
                inventory_id = 56,
                friendly_section = '',
                section = '',
                friendly_row = '',
    ...
    def testUpdatePurchaseInventoryRequest(self):
        """Test UpdatePurchaseInventoryRequest"""
