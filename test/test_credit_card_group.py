...
class TestCreditCardGroup(unittest.TestCase):
    """CreditCardGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreditCardGroup:
        """Test CreditCardGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreditCardGroup`
        """
        model = CreditCardGroup()
        if include_optional:
            return CreditCardGroup(
                ...
                description = '',
                credit_cards = [
                    skybox_openapi_client.models.credit_card.CreditCard(
                        token = '', 
                        billing_address = skybox_openapi_client.models.billing_address.BillingAddress(
                            first_name = '', 
                            last_name = '', 
                            email = '', 
                            address1 = '', 
