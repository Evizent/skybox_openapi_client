...
class TestTaxTags(unittest.TestCase):
    """TaxTags unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaxTags:
        """Test TaxTags
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaxTags`
        """
        model = TaxTags()
        if include_optional:
            return TaxTags(
