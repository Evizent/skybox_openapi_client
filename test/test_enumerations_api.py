...
class TestEnumerationsApi(unittest.TestCase):
    """EnumerationsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = EnumerationsApi()

    def tearDown(self) -> None:
        pass

    def test_enumerations_enumeration(self) -> None:
        """Test case for enumerations_enumeration
