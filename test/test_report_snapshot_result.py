...
class TestReportSnapshotResult(unittest.TestCase):
    """ReportSnapshotResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportSnapshotResult:
        """Test ReportSnapshotResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportSnapshotResult`
        """
        model = ReportSnapshotResult()
        if include_optional:
            return ReportSnapshotResult(
                ...
                report_id = 56,
                filters = [
                    skybox_openapi_client.models.report_snapshot_filter.ReportSnapshotFilter(
                        name = '', 
                        label = '', 
                        label_value = '', 
                ...
                report = skybox_openapi_client.models.report.Report(
                    report_definition = skybox_openapi_client.models.report_definition.ReportDefinition(
                        id = 56, 
                        name = '', 
                        description = '', 
                        help = '', 
                        ...
                        parameters = [
                            skybox_openapi_client.models.report_parameter.ReportParameter(
                                name = '', 
                                label = '', 
                                type = 'DATE', 
                                value = skybox_openapi_client.models.value.value(), 
                                ...
                                gmt = True, 
                                required = True, 
                                is_illegal_filter = True, 
                                default_hidden = True, 
                                disable_all_any_selector = True, 
                                table = '', 
                                column = '', 
                                pattern = '', 
                                mode = '', 
                        ...
                        groups = [
                            skybox_openapi_client.models.report_group.ReportGroup(
                                name = '', )
                            ], 
                        columns = [
                            skybox_openapi_client.models.report_column.ReportColumn(
                                name = '', 
                                label = '', 
                                value = '', 
                                data_type = '', 
    ...
    def testReportSnapshotResult(self):
        """Test ReportSnapshotResult"""
