...
class TestBulkSwapEventRequest(unittest.TestCase):
    """BulkSwapEventRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkSwapEventRequest:
        """Test BulkSwapEventRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkSwapEventRequest`
        """
        model = BulkSwapEventRequest()
        if include_optional:
            return BulkSwapEventRequest(
                inventory_ids = [
                    56
                    ],
                event_id = 56
    ...
    def testBulkSwapEventRequest(self):
        """Test BulkSwapEventRequest"""
