...
class TestInventoryTaxedCostUpdateBulk(unittest.TestCase):
    """InventoryTaxedCostUpdateBulk unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InventoryTaxedCostUpdateBulk:
        """Test InventoryTaxedCostUpdateBulk
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InventoryTaxedCostUpdateBulk`
        """
        model = InventoryTaxedCostUpdateBulk()
        if include_optional:
            return InventoryTaxedCostUpdateBulk(
                new_taxed_cost = 0.0,
                id = 1
            )
        else:
    ...
    def testInventoryTaxedCostUpdateBulk(self):
        """Test InventoryTaxedCostUpdateBulk"""
