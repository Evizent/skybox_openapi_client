...
class TestBulkInvoiceUpdate(unittest.TestCase):
    """BulkInvoiceUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkInvoiceUpdate:
        """Test BulkInvoiceUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkInvoiceUpdate`
        """
        model = BulkInvoiceUpdate()
        if include_optional:
            return BulkInvoiceUpdate(
                invoice_ids = [
                    56
                    ],
                ...
                payment_ref = '',
                payment_ref_payment_method = 'CREDITCARD',
                customer_id = 56,
                invoice_note = '',
    ...
    def testBulkInvoiceUpdate(self):
        """Test BulkInvoiceUpdate"""
