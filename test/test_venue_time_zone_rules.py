...
class TestVenueTimeZoneRules(unittest.TestCase):
    """VenueTimeZoneRules unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VenueTimeZoneRules:
        """Test VenueTimeZoneRules
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VenueTimeZoneRules`
        """
        model = VenueTimeZoneRules()
        if include_optional:
            return VenueTimeZoneRules(
                fixed_offset = True,
                transitions = [
    ...
    def testVenueTimeZoneRules(self):
        """Test VenueTimeZoneRules"""
