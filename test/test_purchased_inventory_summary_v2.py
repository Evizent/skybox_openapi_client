...
class TestPurchasedInventorySummaryV2(unittest.TestCase):
    """PurchasedInventorySummaryV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PurchasedInventorySummaryV2:
        """Test PurchasedInventorySummaryV2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PurchasedInventorySummaryV2`
        """
        model = PurchasedInventorySummaryV2()
        if include_optional:
            return PurchasedInventorySummaryV2(
                purchase_line_id = 56,
                account_id = 56,
                ...
                seat_type = 'CONSECUTIVE',
                cost = 1.337,
                available_cost = 1.337,
                sold_cost = 1.337,
                quantity = 56,
                available_quantity = 56,
                sold_quantity = 56,
                cancelled_quantity = 56,
                seat_numbers = [
                    56
                    ],
                in_hand_date = [
                ...
                unit_cost = 1.337,
                consignment_status = '',
                ticket_face_value_average = 1.337,
                received = '',
                credit_card_group = '',
                ...
                tickets_merged = True,
                last_purchase_note = '',
                last_purchase_note_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                inventory_public_notes = '',
                taxed_cost = 1.337,
                unit_taxed_cost = 1.337
            )
        else:
            return PurchasedInventorySummaryV2(
        )
    ...
    def testPurchasedInventorySummaryV2(self):
        """Test PurchasedInventorySummaryV2"""
