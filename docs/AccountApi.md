# skybox_openapi_client.AccountApi

All URIs are relative to *https://skybox.vividseats.com/services*

Method | HTTP request | Description
------------- | ------------- | -------------
[**account_get**](AccountApi.md#account_get) | **GET** /account | 
[**account_get_notifications**](AccountApi.md#account_get_notifications) | **GET** /account/notifications | 
...
# **account_get_notifications**
> List[Notification] account_get_notifications(client_timezone=client_timezone)
...
with skybox_openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = skybox_openapi_client.AccountApi(api_client)
    client_timezone = 'client_timezone_example' # str |  (optional)

    try:
        api_response = api_instance.account_get_notifications(client_timezone=client_timezone)
        print("The response of AccountApi->account_get_notifications:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AccountApi->account_get_notifications: %s\n" % e)
```
