# skybox_openapi_client.AlertsApi

All URIs are relative to *https://skybox.vividseats.com/services*

Method | HTTP request | Description
------------- | ------------- | -------------
[**alerts_acknowledge**](AlertsApi.md#alerts_acknowledge) | **DELETE** /alerts/{alert-id} | 
[**alerts_get_by_account**](AlertsApi.md#alerts_get_by_account) | **GET** /alerts | 
[**alerts_get_by_id**](AlertsApi.md#alerts_get_by_id) | **GET** /alerts/{alert-id} | 


# **alerts_acknowledge**
> alerts_acknowledge(alert_id)
...
with skybox_openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = skybox_openapi_client.AlertsApi(api_client)
    alert_id = 56 # int | The alert id

    try:
        api_instance.alerts_acknowledge(alert_id)
    except Exception as e:
        print("Exception when calling AlertsApi->alerts_acknowledge: %s\n" % e)
```
...
> List[Alert] alerts_get_by_account()
...
with skybox_openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.alerts_get_by_account()
...
# **alerts_get_by_id**
> Alert alerts_get_by_id(alert_id)



Retrieves an alert by the alert id
...
with skybox_openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.alerts_get_by_id(alert_id)
        print("The response of AlertsApi->alerts_get_by_id:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AlertsApi->alerts_get_by_id: %s\n" % e)
```
